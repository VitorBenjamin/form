...
class PaginasController extends Controller
{
    public function index()
    {
        ...
        $parceiros = Parceiro::all('thumb');
        $continentes = Continente::all('nome');
        $viagens = Viagem::where('ativo',true)->take(21)->orderBy('created_at','desc')->get();
        $artigos = Artigo::take(3)->orderBy('created_at','desc')->get();
        ...
        return view('index',compact('categorias','parceiros','continentes','artigos','viagens','carousels','clientes','check','dicas','especial'));
    }
    public function exibirTodasViagens()
    {
        $categorias = Categoria::all('nome','thumb');
        $continentes = Continente::all('nome');
        $viagens = Viagem::where('ativo',true)->orderBy('created_at','desc')->get();
        $clientes = Cliente::all();
        $check = Dica::where('tipo','CHECK-IN')->take(8)->get();
        $dicas = Dica::where('tipo','DICAS-VIAGENS')->take(8)->get();
        $especial = Viagem::where('especial',true)->first();
    ...
    public function exibirTodosArtigos()
    {
        $artigos = Artigo::orderBy('created_at','desc')->get();
        $clientes = Cliente::all();
        return view('artigo.todas',compact('artigos','clientes'));
    }
    ...
    public function exibirArtigo($titulo)
    {

        $artigo = Artigo::where('titulo',$titulo)->first();
        $clientes = Cliente::all();
        ...
        return view('artigo.index',compact('clientes','artigo'));
    }
    ...
    public function postSearch(Request $request)
    {
        ...
        ->select('id','titulo','destino','thumb')
        ->get();
