      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6" style="margin-top:35px">
            <img class="roteiro-img" src="{{asset ('assets/icon-email.svg')}}" alt="" style="width:25px">
            <span class="roteiro-span">byana@formulaturismo.com.br</span>
            <img class="roteiro-img" src="{{asset('assets/icon-telefone.svg')}}" alt="" style="width:25px">
